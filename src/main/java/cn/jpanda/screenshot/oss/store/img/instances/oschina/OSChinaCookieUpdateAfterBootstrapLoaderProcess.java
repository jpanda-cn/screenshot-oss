...
public class OSChinaCookieUpdateAfterBootstrapLoaderProcess implements AfterBootstrapLoaderProcess {
    ...
    public void  doUpdateCookie(){
        ...
        OSChainPersistence osChainPersistence=configuration.getPersistence(OSChainPersistence.class);
        String cookie=osChainPersistence.getCookie();
        ...
        Long expire=osChainPersistence.getExpire();
        ...
        requestForRefresh(osChainPersistence);
    }
public void  cookieExpireTips(){
    ...
    public void requestForRefresh(OSChainPersistence osChainPersistence){
        try (
                CloseableHttpClient client= HttpClients.custom()
                        ...
                        .setDefaultHeaders(Collections.singletonList(
                                new BasicHeader("Cookie", osChainPersistence.getCookie()))
            ...
            if (response.getStatusLine().getStatusCode()==200){
                ...
                osChainPersistence.setExpire(now.getTime()+1000*60*60*24*365L);
                configuration.storePersistence(osChainPersistence);
            }else {
